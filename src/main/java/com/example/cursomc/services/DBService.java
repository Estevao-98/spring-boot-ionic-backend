...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "manhaes.estevao@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
        ...
        Pedido ped2 = new Pedido(null, sdf.parse("30/10/2017 12:32:00"), cli1, e2);

        Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
        ped1.setPagamento(pagto1);

        Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("30/10/2017 12:32:00"), null);
